...
import { TbArchive, TbActivityHeartbeat, TbNetwork } from "solid-icons/tb"
...
export const side_menu_items: SideMenuItem[] = [
  ...
  // },
  {
    title: "manage.sidemenu.certificate",
    icon: BsFingerprint,
    to: "/@manage/certificate",
    component: lazy(() => import("./certificate")),
  },
  {
    title: "manage.sidemenu.system-monitoring",
    icon: TbActivityHeartbeat,
    to: "/@manage/system-monitoring",
    component: lazy(() => import("./system-monitoring")),
  },
  {
    title: "manage.sidemenu.network-control",
    icon: TbNetwork,
    to: "/@manage/network-control",
    component: lazy(() => import("./network-control")),
  },
  // {
